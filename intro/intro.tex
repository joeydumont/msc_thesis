...
specular reflection upon contact with an obstacle \cite[\S287]{RAY1878}. 
...
is concentrated in an annulus near the boundary of the gallery \cite{RAY1910}, 
...
phenomena remained only a matter of curiosity \cite{WRI2012}. It was brought
...
The whispering-gallery phenomena in dielectric media can be explained
...
as the electric field does not leave the confines of its metallic prison. The
...
allows the wave to leak, or couple, to the exterior of the cavity. This has a slew
of experimental and theoretical consequences. 
...
ensemble the cavity describes. 

Close cavities, are, however, an idealization of the much more
...
to the field before the interaction, i.e. it describes the effect of the potential
on an incoming field. The scattering approach allows us to define the modes of 
open cavities, a problem that is perhaps more complicated that it seems (Fox-Li modes, modes of
wave-chaotic...). \todo{Discuss resonances and $Q$ values.}

Open dielectric cavities also allow a semiclassical approximation, mathematically
...
to specific purposes \todo{Discuss CAT, biosensing, microlasers...}. The fact
...
mechanics experimentally. This stems from the similarities between the
...
values of $Q\sim10^7-10^9$ using highly symmetrical cavity designs. \todo{Add references.} 
This symmetry implies that the far-field emission is also symmetry: it usually is
...
lead to interesting phenomena, such as \todo{add references.}...

In this thesis, we will a second degree of freedom in the design
...
experimentally by the use of nematics. Moreover, we will see that the numerical
...
The expertise developed in the study of dielectric cavities was 
later extended to lasing cavities and proposed for arbitrary
...
We generalize a scattering method by G.P.-A. \cite{GAP2013} for 
