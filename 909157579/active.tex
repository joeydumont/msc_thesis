...
of the power carried by this light/current will be reflected 
...
wavelength. Figure \ref{fig:active.antennae.fibre-antenna.xsection} shows a cross-section
...
We will use the fact that the first radiation harmonics of a \gls{lcx} is given 
...
do not possess any symmetry and metallic layers of high, though not infinite,
...
\subsubsection[Analysis of Experimental Traces]{Analysis of Experimental Traces\footnote{All experimental measurements were obtained by our local experimental group at Centre d'Optique Photonique et Laser at Université Laval, by either Stephan Gorgutsa or Victor Bélanger-Garnier.}}
...
\begin{figure}[h]
 ...
 \caption[Experimental $S_{22}$ trace of the RF10 fibre-antenna]
 		...
 		The relatively small background value of $\sim -4\,\unit{dB}$ indicates
