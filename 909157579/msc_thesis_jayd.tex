...
% % PATCH FOR LINENO TO WITH WITH ALINGED EQUATIONS
...
\input{tikz-config.tex}              % Styles and configuration of TikZ.
\input{commands.tex}                 % Custom commands and theorem environments.
