...
\caption[Schematic representation of whispering-gallery modes]
	{Schematic representation of whispering-gallery modes\index{whispering gallery} in closed
...
equation\index{partial differential equation}, together with the \gls{dirichletBC}, translate to an
...
factor, or $Q$-factor\index{$Q$-factor}, which is defined via the positions of the resonances
...
cavity and then escape the confines of the cavity. The \textit{time-delay}\index{time-delay} introduced
